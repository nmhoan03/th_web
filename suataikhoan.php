...
if (isset($_POST['ok'])) {
    ...
    $taikhoan->quyen = isset($_POST['quyen']) ? $_POST['quyen'] : 0;
    $taikhoan->update();
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="container">
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                <label for="quyen">Chọn quyền người dùng:</label>
                <select class="form-control" name="quyen" id="quyen">
                    <option value="0" <?php if ($row['quyen'] == 0) echo "selected"; ?>>Người dùng</option>
                    <option value="1" <?php if ($row['quyen'] == 1) echo "selected"; ?>>Quản lý</option>
                </select>
            </div>
