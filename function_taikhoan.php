...
function insert1(){
    $sql = "INSERT INTO `taikhoan`(`tendangnhap`, `matkhau`, `hoten`, `email`,`enable`,`quyen`) 
    VALUES ('".$this->tendangnhap."','".$this->matkhau."','".$this->hoten."','".$this->email."','".$this->enable."','".$this->quyen."')";
    $result = mysqli_query($this->conn,$sql);
       if($result){
